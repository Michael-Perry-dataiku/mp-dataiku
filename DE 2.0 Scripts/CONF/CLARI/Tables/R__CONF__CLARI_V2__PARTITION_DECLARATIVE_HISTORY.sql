...
\outl0\strokewidth0 \strokec2 CREATE OR REPLACE DYNAMIC TABLE \{\{CONF\}\}.CLARI_V2.PARTITION_DECLARATIVE_HISTORY\
...
as\
SELECT \
"partitionDate"::DATE AS PARTITION_DATE,\
...
"parentHierarchyName" AS PARENT_HIERARCHY_NAME,\
...
'PG_ANALYTICS' AS META_SOURCE_NAME,\
CASE\
...
ELSE NULL\
END AS ARR_VERSION\
FROM RAW.CLARI_DSS.MIGRATED_DECLARATIVE_PARTITIONS D\
