...
\outl0\strokewidth0 \strokec2 CREATE OR REPLACE DYNAMIC TABLE \{\{CONF\}\}.SALESFORCE_V2.ENGAGEMENT_CONTACT\
...
"Customer_Engagement__c" AS Customer_Engagement__c,\
"Customer_Engagement_Contact__c" AS Customer_Engagement_Contact__c,\
...
FROM raw.salesforce_dss.engagement_contact}